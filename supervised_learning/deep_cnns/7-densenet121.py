...
def densenet121(growth_rate=32, compression=1.0):
    ...
    # First BN-ReLU-Conv, with double the growth rate
    ...
    conv_layer =\
        K.layers.Conv2D(filters=nb_filters,
                        kernel_size=(7, 7),
                        strides=(2, 2),
                        padding="same",
    ...
    max_pool_layer =\
        K.layers.MaxPool2D(pool_size=(3, 3),
                           strides=(2, 2),
    ...
    block1, nb_filters = dense_block(max_pool_layer, nb_filters,
                                     growth_rate, 6)
    ...
    avg_pool_layer = K.layers.AvgPool2D(pool_size=(7, 7),
                                        strides=(1, 1))(block4)
