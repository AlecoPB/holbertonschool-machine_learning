#!/usr/bin/env python3
"""
WGAN_clip: Wasserstein GAN with Weight Clipping
"""
...
class WGAN_clip(keras.Model):
    """
    WGAN_clip class for Wasserstein GAN with Weight Clipping.
    """
    def __init__(self, generator, discriminator, latent_generator, real_examples, batch_size=200, disc_iter=2, learning_rate=.005):
        ...
        self.generator.loss = lambda x: -tf.math.reduce_mean(x)  # Generator loss
        ...
        self.discriminator.loss = lambda x, y: tf.math.reduce_mean(y) - tf.math.reduce_mean(x)  # Discriminator loss
    ...
    def train_step(self, useless_argument=None):
